...
use GoldSpecDigital\LaravelEloquentUUID\Tests\Models\TestModelExtendingClassWithUuid7;
...
class ModelExtendingClassWithUuidTest extends TestCase
{
    ...
    /** @test */
    public function it_generates_a_uuid7_when_the_id_has_not_been_set(): void
    {
        /** @var \GoldSpecDigital\LaravelEloquentUUID\Tests\Models\TestModelExtendingClassWithUuid7 $testModel */
        $testModel = TestModelExtendingClassWithUuid7::query()->create();
    ...
    /** @test */
    public function it_uses_the_uuid7_provided_when_id_has_been_set(): void
    {
        $uuid = Str::uuid()->toString();
