...
use GoldSpecDigital\LaravelEloquentUUID\Tests\Models\TestModelUsingTraitWithUuid7;
...
class ModelUsingTraitWithUuidTest extends TestCase
{
    ...
    {
        /** @var \GoldSpecDigital\LaravelEloquentUUID\Tests\Models\TestModelUsingTraitWithUuid7 $testModel */
        $testModel = TestModelUsingTraitWithUuid7::query()->create();
